...
<p align="center">
<img src="https://readme-typing-svg.herokuapp.com?size=30&duration=3000&color=1F75FE&center=true&vCenter=true&width=600&lines=Daniel+Davis+Thattil;Mechanical+Engineering+Student">
</p>
...
### Research Intern
Vehicle Research and Development Establishment (VRDE - DRDO) | Sept 2025 – Feb 2026

- Contributed to design and analysis of a mechanical actuation system for a vehicle-mounted assembly.
- Performed torque estimation, load calculations, and factor of safety analysis.
- Designed structural components such as tilt beam assembly using SolidWorks.
- Developed Excel-based analytical models to estimate cylinder forces and hydraulic system sizing.


### Mechanical Engineering Intern
Suprajit Automotive Ltd., Bangalore | Jun – Jul 2025

- Observed automotive control cable manufacturing processes.
- Worked with design teams using SolidWorks for cable component modelling.
- Learned GD&T basics and industrial quality systems such as PFMEA and Poka-Yoke.


### Mechanical Engineering Intern
Steel and Industrial Forgings Ltd., Kerala | Jun 2025

- Exposure to forging, machining, heat treatment, and CNC manufacturing.
- Learned material testing, metallurgical analysis, and NDT procedures.

---

## Projects

### SAE National E-Scooter Design Competition
- Contributed to mechanical assembly and chassis integration of an electric scooter.
- Ensured structural integrity and drivetrain alignment.
- Worked with a cross-functional team to troubleshoot mechanical integration issues.


### 3-in-1 Agricultural Tool
- Designed and fabricated a multi-functional spade hoe combining hoe, cutter, and shovel.
- Used recycled materials to improve sustainability and usability.
...
- Theory and Practice of Non Destructive Testing – NPTEL (IIT Madras)
- Product Design & Development – NPTEL (IIT Roorkee)

---

## Leadership

Placement Representative – Mechanical Department

- Coordinated with recruiters for campus placement activities.
- Assisted students during recruitment processes.

Event Coordinator – MEXTALK 3.0

- Organized an industry interaction session with Tata Motors.
- Helped facilitate student-industry engagement and professional networking.
